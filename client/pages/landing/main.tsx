...
export default function MainPage() {
  ...
  <div className="beg37 hvqt3">
    <div className="er0d1 fglch xf1r4 ids43 mx-auto">
      {/* Title */}
      <div className="w6mr2 vwt7a mx-auto dtief">
        <h2 className="cnneu a3jay c9jt8 dark:text-neutral-200">
      ...
      {/* End Title */}
      <div className="vwt7a mx-auto">
        {/* Accordion */}
        <div className="hs-accordion-group">
          <div
            className="hs-accordion hs-accordion-active:bg-gray-100 jq72l er6t7 dark:hs-accordion-active:bg-neutral-800 active"
            id="hs-basic-with-title-and-arrow-stretched-heading-one"
          >
            <button
              className="hs-accordion-toggle group inline-flex items-center ox2cl vyfcq w-full sikx1 w9dei c9jt8 focus:outline-hidden dark:text-neutral-200"
              aria-expanded="true"
              aria-controls="hs-pro-dtc-one"
            >
              Can I cancel at anytime?
              <svg
                className="hs-accordion-active:hidden block e731n yhc35"
                xmlns="http://www.w3.org/2000/svg"
                width={24}
                height={24}
                viewBox="0 0 24 24"
              ...
              <svg
                className="hs-accordion-active:block hidden e731n yhc35"
                xmlns="http://www.w3.org/2000/svg"
                width={24}
                height={24}
                viewBox="0 0 24 24"
            ...
            <div
              id="hs-pro-dtc-one"
              className="hs-accordion-content w-full overflow-hidden transition-[height] ufjzp"
              role="region"
              aria-labelledby="hs-basic-with-title-and-arrow-stretched-heading-one"
            >
              <div className="f5e2w">
                <p className="c9jt8 dark:text-neutral-200">
          ...
          <div
            className="hs-accordion hs-accordion-active:bg-gray-100 jq72l er6t7 dark:hs-accordion-active:bg-neutral-800"
          ...
          >
            ...
            <div
              id="hs-pro-dtc-two"
              className="hs-accordion-content hidden w-full overflow-hidden transition-[height] ufjzp"
              role="region"
