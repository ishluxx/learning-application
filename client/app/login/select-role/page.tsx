      ...
      <div className="h1r77 vvwug jcysb flex flex-col jkwm1 mx-auto space-y-5">
        ...
        <div>
          <h1 className="mp30q o0lhv cnneu c9jt8 dark:text-neutral-200">
            Log in to your E-lab account
          </h1>
          <p className="rwavo w4xo0 jy5gh dark:text-neutral-500">
            Learn With E-lab made simple. Please select your role to continue.
          </p>
        </div>
        {/* End Title */}
    ...
    {/* End Checkbox Grid */}
        ...
        <form>
          <div className="space-y-5">
            ...
            <div>
              <div className="flex ox2cl items-center wyf4w">
                <label
                  htmlFor="hs-pro-dalp"
                  className="block w4xo0 sikx1 c9jt8 dark:text-white"
                >
                  Password
                </label>
                <Link
                  className="inline-flex items-center b1nd2 xs2f2 fd43e hbear j3zsq f1348 focus:outline-hidden ow4j6 dark:text-neutral-500 dark:hover:text-neutral-600"
                  href="/login/pswrecovery"
                >
        ...
        <p className="w4xo0 jy5gh dark:text-neutral-500">
          New to E-lab? 
          <Link
            className="pl-2 inline-flex items-center n6i5x w4xo0 igv60 j3zsq f1348 sikx1 focus:outline-hidden ow4j6 dark:text-blue-500"
