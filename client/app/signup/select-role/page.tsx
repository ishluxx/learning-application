  ...
  <main className="flex ou4zs max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 mt-4 mb-4">
    ...
    <div className="hlt95 ns57r">
      <div className="h1r77 vvwug jcysb flex flex-col jkwm1 mx-auto space-y-5">
       ...
       <div>
    {/* Checkbox Grid */}
    <div className="ylm8n dzapa g27d7">
      {/* Checkbox */}
      <label
        htmlFor="hs-pro-shtoflb1"
        className="an00p mf4b9 xs2f2 flex flex-col jkwm1 items-center suhn5 dtief aqyoh c9jt8 rsdjd lnk45 gzyzm kuxro fao71 cursor-pointer pb094 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:has-checked:border-indigo-500 dark:has-checked:ring-indigo-500"
      >
        <input
          type="radio"
          id="hs-pro-shtoflb1"
          className="hidden w4poy lnk45 g41z1 g22e3 axcnw dark:text-indigo-500 dark:border-neutral-700 dark:focus:ring-neutral-900"
          defaultValue="@@title"
          name="hs-pro-shtoflb"
        />
        <svg
          className="e731n yhc35 mx-auto"
          xmlns="http://www.w3.org/2000/svg"
          width={24}
          height={24}
          viewBox="0 0 24 24"
        ...
        <span className="block ja90s">Student</span>
      </label>
      {/* End Checkbox */}
      {/* Checkbox */}
      <label
      ...
      >
        ...
        <span className="block ja90s">Teacher</span>
      </label>
      {/* End Checkbox */}
    </div>
    {/* End Checkbox Grid */}
  </div>
        <div className="flex items-center xs2f2 rr36x vj9jb before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-700 dark:after:border-neutral-700">
          With
        </div>
        <form>
